...
export default function CTABanner({ onFindFood, onListSurplus }) {
  return (
    <section className=" max-w-full px-6 py-16 flex flex-col lg:flex-row items-center gap-8">
      ...
      <div className="w-full lg:w-[50%] flex flex-col gap-3 lg:-ml-20 text-center lg:text-left">
        <h2 className="lg:text-h2 md:text-[30px] z-50 text-h3 font-bold text-white">
          Ready to Find or Share Your Next Meal?
        </h2>
        <p className=" text-normal md:text-body1 text-white/85 mt-2 max-w-xl">
