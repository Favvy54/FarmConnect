import FoodBasket from "../assets/images/food-icon.png" 
import Speed from "../assets/images/lightining-icon.png"
import Recycle from "../assets/images/recycle-icon.png"
import Handshake from "../assets/images/handshake-icon 1.png"
...
export default function WhyChoose() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <h2 className="text-h2 font-bold text-green-normal">Why choose FarmConnect?</h2>
      <p className="text-body1 text-body-text mt-3 max-w-2xl">
        From discovering quality meals to helping vendors reduce waste, FarmConnect makes surplus
        food easier to share, reserve, and collect.
      </p>
      ...
      <div className="grid md:grid-cols-4 gap-6 mt-10">
        {FEATURES.map(({ icon: Icon, title, body }) => (
          ...
          >
            <img src={Icon} className= "w-8 h-8 mb-4"/>
